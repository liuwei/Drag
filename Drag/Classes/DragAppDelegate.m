...
//	_viewController.isOverlayingDeviceCamera = YES;
	...
	CC3Layer* cc3Layer = [DragLayer layerWithController: _viewController];
	
	// Create the customized 3D scene and attach it to the layer.
	// Could also just create this inside the customer layer.
	cc3Layer.cc3Scene = [DragScene scene];
...
//	cc3Layer.contentSize = CGSizeMake(winSize.width - 100.0, winSize.width - 40.0);
    /*vincent add
    cc3Layer.position = ccp(384.0, 0.0);
    cc3Layer.contentSize = CGSizeMake(winSize.width/2, winSize.width/2);
    */
